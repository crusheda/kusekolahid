<?php  
    ...
    $sql=mysql_query("select * from berita_prestasi where id=1;");
    $berita1 = mysql_fetch_object($sql);

    $sql2=mysql_query("select * from berita_prestasi where id=2;");
    $berita2 = mysql_fetch_object($sql2);

    $sql3=mysql_query("select * from berita_prestasi where id=3;");
    $berita3 = mysql_fetch_object($sql3);

    $sql4=mysql_query("select * from berita_prestasi where id=4;");
    $berita4 = mysql_fetch_object($sql4);

    $sql5=mysql_query("select * from berita_prestasi where id=5;");
    $berita5 = mysql_fetch_object($sql5);

    $sql6=mysql_query("select * from berita_prestasi where id=6;");
      ...
      <div class="column">
        ...
        <div class="ui hidden transition information">
          <h1 class="ui inverted centered header">
            ...
            <p class="ui centered lead">Prestasi-prestasi yang sudah dicapai<br>dari berbagai sekolah.</p>
          <br>
        </div>
      </div>
    </div>
      ...
      <div class="ui three column aligned stackable divided grid">
        ...
        <div class="column">
          <div class="ui card" data-html="<div class='header'>User Rating</div><div class='content'><div class='ui star rating'><i class='active icon'></i><i class='active icon'></i><i class='active icon'></i><i class='active icon'></i><i class='icon'></i></div></div>">
            ...
            <div class="ui blue button" onclick="window.location.href='prestasiartikel.php?id= <?php echo $berita1->id;?>'">
        ...
        <div class="column">
          <div class="ui card" data-html="<div class='header'>User Rating</div><div class='content'><div class='ui star rating'><i class='active icon'></i><i class='active icon'></i><i class='icon'></i><i class='icon'></i><i class='icon'></i></div></div>">
            <div class="image">
            ...
            <div class="content">
              ...
              <div class="description">
               ...
               <div class="ui blue button" onclick="window.location.href='prestasiartikel.php?id=<?php echo $berita2->id;?>'">
                <i class="flaticon-outcoming icon"></i>
                Lihat
               </div>  
          </div>
          ...
          <div class="ui card" data-html="<div class='header'>User Rating</div><div class='content'><div class='ui star rating'><i class='active icon'></i><i class='active icon'></i><i class='icon'></i><i class='icon'></i><i class='icon'></i></div></div>">
            ...
            <div class="content">
              ...
              <div class="description">
               ...
               <div class="ui blue button" onclick="window.location.href='prestasiartikel.php?id=<?php echo $berita3->id;?>'">
                <i class="flaticon-outcoming icon"></i>
                Lihat
               </div>  
          </div>
          ...
          <div class="ui card" data-html="<div class='header'>User Rating</div><div class='content'><div class='ui star rating'><i class='active icon'></i><i class='active icon'></i><i class='icon'></i><i class='icon'></i><i class='icon'></i></div></div>">
            ...
            <div class="content">
              ...
              <div class="description">
               ...
               <div class="ui blue button" onclick="window.location.href='prestasiartikel.php?id=<?php echo $berita4->id;?>'">
                <i class="flaticon-outcoming icon"></i>
                Lihat
               </div>  
          </div>
          ...
          <div class="ui card" data-html="<div class='header'>User Rating</div><div class='content'><div class='ui star rating'><i class='active icon'></i><i class='active icon'></i><i class='icon'></i><i class='icon'></i><i class='icon'></i></div></div>">
            ...
            <div class="content">
              ...
              <div class="description">
               ...
               <div class="ui blue button" onclick="window.location.href='prestasiartikel.php?id=<?php echo $berita5->id;?>'">
                <i class="flaticon-outcoming icon"></i>
                Lihat
               </div>  
          </div>
          ...
          <div class="ui card" data-html="<div class='header'>User Rating</div><div class='content'><div class='ui star rating'><i class='active icon'></i><i class='active icon'></i><i class='icon'></i><i class='icon'></i><i class='icon'></i></div></div>">
            ...
            <div class="content">
              ...
              <div class="description">
               ...
               <div class="ui blue button" onclick="window.location.href='prestasiartikel.php?id=<?php echo $berita6->id;?>'">
                <i class="flaticon-outcoming icon"></i>
                Lihat
               </div>  
          </div>
