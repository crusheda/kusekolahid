         ...
         <div class="ui inline dropdown">
          ...
          <div class="ui hidden transition information">
            <h1 class="ui inverted centered header">
                  ...
                  <h2><u>Mengelola Data Wakil Kepala Sekolah</u></h2>
            </h1>
            <br>
          </div>
        </div>  
  ...
  <br>
    ...
    $batas    = 10;
        ...
        <div class="scrollmenu">
              ...
              <td>  
                <center><button class="ui icon blue button" onclick="window.location.href='editwakasek.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon red button" onclick="window.location.href='hapuswakasek.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
  		      </tr>
  		      <?php 
