...
<head>
         ...
         <div class="ui inline dropdown">
          ...
          <div class="ui hidden transition information">
            <h1 class="ui inverted centered header">
                  ...
                  <h2><u>Mengelola Data Siswa</u></h2>
            </h1>
            <br>
          </div>
        </div>  
  ...
  <!-- Isi Body -->
  <br>
  <div class="ui horizontal divider"><a>Siswa</a></div>
  ...
  <div class="ui icon input">
    ...
    <div class="ui mini horizontal menu">
      <a class="item" style="color: black" href="addsiswa.php">
        Tambah Data      
      </a>
  ...
  <br>
    ...
    $batas    =  10;
		...
		$sql = "SELECT count(npsn) FROM siswa ";
        ...
        <div class="scrollmenu">
  		    <table class="ui selectable celled table" id="tabelsiswa" style="scroll-behavior: 2">
  		      <thead>
  		      <tr>
              ...
              <th><center>Tahun Ajaran</center></th>
  		        ...
  		        <th><center>Jumlah Putra</center></th>
              <th><center>Jumlah Putri</center></th>
              <th><center>Kms</center></th>
              <th><center>Non Kms</center></th>
              ...
              <td><?php echo "{$row['kms']}"?></td>
  		        <td><?php echo "{$row['non_kms']}"?></td>
              <td><?php echo "{$row['jumlah_siswa']}"?></td>
              <td>  
                <center><button class="ui icon blue button" onclick="window.location.href='editsiswa.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon red button" onclick="window.location.href='hapussiswa.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
  		      </tr>
  		      <?php 
      ...
      <div class="ui container">
        <div class="ui mini horizontal menu">
        <a class="right menu item">
          <button class=" ui simple small blue button" onclick="window.location.href='siswaadm.php?page=$page'"><b>Next Data</b>
          </button>
        </a>
        <?php 
    		if( $page > 0 )
    		{
    		   $last = $page - 2;
           echo "<br>";
    		   echo "<a class=\"left menu item\"><button class=\" ui simple small blue button \" onclick=\"window.location.href='siswaadm.php?page=$last'\"><b>Previous Data<b></button></a>";

    		   echo "<a class=\"right menu item\"><button class=\" ui simple small blue button \" onclick=\"window.location.href='siswaadm.php?page=$page'\"><b>Next Data</b></button></a>";
    		}
    		else if( $page == 0 )
    		{
    		   echo "<a class=\"right menu item\"><button class=\" ui simple small blue button \" onclick=\"window.location.href='siswaadm.php?page=$page'\"><b>Next Data</b></button></a>";
