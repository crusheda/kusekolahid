...
<head>
        ...
        <div class="ui secondary pointing menu">
          ...
          <div class="ui hidden transition information">
            <h1 class="ui inverted centered header">
                  ...
                  <h2><u>Mengelola Data Kepsek</u></h2>
            </h1>
            <br>
          </div>
        </div>  
  ...
  <br>
    ...
    $batas    = 10;
		...
		$sql = "SELECT count(npsn) FROM kepsek ";
        ...
        <div class="scrollmenu">
              ...
              <td>  
                <center><button class="ui icon blue button" onclick="window.location.href='editkepsek.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon red button" onclick="window.location.href='hapuskepsek.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
  		      </tr>
  		      <?php 
