...
<head>
  ...
  <!-- Isi Body -->
  <br>
  <div class="ui horizontal divider"><a>Data Guru</a></div>
  ...
  <br>
    ...
    $batas    = 10;
        ...
        <div class="scrollmenu">
              ...
              <td>  
                <center><button class="ui icon blue button" onclick="window.location.href='edit_data_guru.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon red button" onclick="window.location.href='hapus_data_guru.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
  		      </tr>
  		      <?php 
