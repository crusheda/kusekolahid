...
<head>
        ...
        <div class="ui secondary pointing menu">
          ...
          <div class="ui hidden transition information">
            <h1 class="ui inverted centered header">
                  ...
                  <h2><u>Mengelola Data Aset Bangunan</u></h2>
            </h1>
  ...
  <div class="ui icon input">
    ...
    <div class="ui mini horizontal menu">
      <a class="item" style="color: black" href="add_aset_bangunan.php">
        Tambah Data      
      </a>
  ...
  <br>
    ...
    $batas = 10;
        ...
        <div class="scrollmenu">
  		    <table class="ui selectable celled table" id="tabel_aset_bangunan" style="scroll-behavior: 2">
  		      <thead>
  		      <tr>
  		        <th><center>NPSN</center></th>
              <th><center>Nama Bangunan</center></th>
              <th><center>Kode Bangunan</center></th>
              <th><center>Register Bangunan</center></th>
              <th><center>Kondisi Bangunan</center></th>
              <th><center>Konstruksi Bangunan</center></th>
              <th><center>Luas Lantai</center></th>
              <th><center>Lokasi</center></th>
              <th><center>Tahun Pembangunan</center></th>
              <th><center>Luas Bangunan</center></th>
              <th><center>Biaya Pembangunan</center></th>
              ...
              <td><?php echo "{$row['kode_bangunan']}"?></td>
              <td><?php echo "{$row['register_bangunan']}"?></td>
              <td><?php echo "{$row['kondisi_bangunan']}"?></td>
              <td><?php echo "{$row['kostruksi_bangunan']}"?></td>
              <td><?php echo "{$row['luas_lantai']}"?></td>
              <td><?php echo "{$row['lokasi']}"?></td>
              <td><?php echo "{$row['tahun_pembangunan']}"?></td>
              <td><?php echo "{$row['luas_bangunan']}"?></td>
              <td><?php echo "{$row['biaya_pembangunan']}"?></td>
              <td>  
                <center><button class="ui icon blue button" onclick="window.location.href='edit_aset_bangunan.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon red button" onclick="window.location.href='hapus_aset_bangunan.php?npsn= <?php echo "{$row['npsn']}"?>'">
                </button></center>
              </td> 
  		      </tr>
  		      <?php 
      ...
      <div class="ui container">
        <div class="ui mini horizontal menu">
        <a class="right menu item">
          <button class=" ui simple small blue button" onclick="window.location.href='aset_bangunan_adm.php?page=$page'"><b>Next Data</b>
          </button>
        </a>
        <?php 
    		if( $page > 0 )
    		{
    		   $last = $page - 2;
           echo "<br>";
    		   echo "<a class=\"left menu item\"><button class=\" ui simple small blue button \" onclick=\"window.location.href='aset_bangunan_adm.php?page=$last'\"><b>Previous Data<b></button></a>";

    		   echo "<a class=\"right menu item\"><button class=\" ui simple small blue button \" onclick=\"window.location.href='aset_bangunan_adm.php?page=$page'\"><b>Next Data</b></button></a>";
    		}
    		else if( $page == 0 )
    		{
    		   echo "<a class=\"right menu item\"><button class=\" ui simple small blue button \" onclick=\"window.location.href='aset_bangunan_adm.php?page=$page'\"><b>Next Data</b></button></a>";
    ...
    function fungsisearch() {
      ...
      table = document.getElementById("tabel_aset_bangunan");
